...
<figure><img src="../.gitbook/assets/180922859.png" alt=""><figcaption><p>SNOMED CT allows a single clinical idea to be associated with a range of terms from various languages</p></figcaption></figure>
...
* **Specify the acceptability of the created descriptions in a language reference set**
  ...
  * Principle and process for creating the individual reference set members: [Add Members to a Reference Set](/broken/spaces/qOI2v58ZsXOoklmwBOk4/pages/sMoYVQm1xbAR1PGIoKIF)
