...
* **Specify the acceptability of the created descriptions in a language reference set**
  ...
  * Principle and process for creating the individual reference set members: 6.3.3.1 [Add Members to a Reference Set](https://app.gitbook.com/s/qOI2v58ZsXOoklmwBOk4/6-reference-set-development/6.3-development/6.3.3-authoring-reference-set-members/6.3.3.1-add-members-to-a-reference-set)
