# 5.4.5.1-create-new-reference-set-in-an-extension
...
For more information about a range of purposes for reference sets, please refer to the [Practical Guide to Reference Sets](https://confluence.ihtsdotools.org/display/DOCRFSPG/Practical+Guide+to+Reference+Sets).
...
Reference Set Descriptor Reference Set| A new reference set member is created in the reference set Descriptor for each attribute in the reference set pattern. For guidance on creating a reference set member, please see [6.3.3.1 Add Members to a Reference Set](https://confluence.ihtsdotools.org/display/DOCRFSPG/6.3.3.1+Add+Members+to+a+Reference+Set). For further introduction to the reference set Descriptor, please see [4.1.1. Reference Set Descriptor](https://confluence.ihtsdotools.org/display/DOCRFSPG/4.1.1.+Reference+Set+Descriptor) in [Practical Guide to Reference Sets](https://confluence.ihtsdotools.org/display/DOCRFSPG/Practical+Guide+to+Reference+Sets).\
**Add members to the reference set** Reference set members are added to the reference set, which includes specifying the attribute values for each reference set member, see [6.3.3.1 Add Members to a Reference Set](https://confluence.ihtsdotools.org/display/DOCRFSPG/6.3.3.1+Add+Members+to+a+Reference+Set).
