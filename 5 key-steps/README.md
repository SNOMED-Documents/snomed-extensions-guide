...
4. _Distribution_ - This involves classifying the extension content [\*<sup>1</sup>](#user-content-fn-1)[^1] , packaging the release files, validating the distribution package, and making the release package available to _terminology consumers_.
