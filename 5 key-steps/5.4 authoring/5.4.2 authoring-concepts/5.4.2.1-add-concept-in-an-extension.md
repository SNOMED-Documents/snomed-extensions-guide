...
Key principles for authoring concepts in an extension include
  ...
  * Concepts added to an extension should conform to the policies stated in [5.3.2 Constraints on Concept Requests](5.3.2-Constraints-on-Concept-Requests_59342967.html)
...
Illustration| <figure><img src="../../../images/57815238.png" alt="" title=""><figcaption><p>---|---</p></figcaption></figure>  
...
Illustration| <figure><img src="../../../images/57815237.png" alt="" title=""><figcaption><p>---|---</p></figcaption></figure>  
...
Impact on subsumption| This type of intermediate extension concept does not change the results of subsumption testing between international concepts. It does, however, have an impact on which relationships from the international edition are non-redundant in the extension edition. In this example, the inferred relationship **G |is a| E** becomes redundant when combined with the inferred relationships from the extension.Extension producers can handle this redundancy by:
  ...
  * Inactivating the inferred relationship from the International Edition, i.e. inactivate the relationship **G | is a | E**. For more information, see [5.4.4.3 Inactivate Relationship in an Extension](5.4.4.3-Inactivate-Relationship-in-an-Extension_57815292.html).

  
  
Table 5.4.2.1-3: Example 3 - Extension Concept as an Intermediate Concept (Impact on subsumption)

Illustration| <figure><img src="../../../images/57815236.png" alt="" title=""><figcaption><p>---|---</p></figcaption></figure>  
