...
* The [International Edition](https://confluence.ihtsdotools.org/display/DOCGLOSS/International+Edition)
* A [National extension](https://confluence.ihtsdotools.org/display/DOCGLOSS/National+extension)
* Another extension
...
* Satisfy the criteria of being [understandable, reproducible, useful](https://confluence.ihtsdotools.org/display/DOCGLOSS/Understandability,+Reproducibility+and+Usefulness)
...
Note that, content added to an extension can later be promoted to another extension or to the International Edition. For more information, please refer to [5.4.1.1 Promotion and Demotion](../../5%20key-steps/5.3%20assessing-requests/5.4.1.1-Promotion-and-Demotion_64264454.html).
