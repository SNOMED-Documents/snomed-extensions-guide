...
Please note that a versioned edition is a logical composition of modules, and does not necessarily correspond to a single release package. For more information on release packages, please refer to [4.5 Release Packages](4.5-Release-Packages_57815193.html) and [5.6.1.2 Packaging and File Naming](5.6.1.2-Packaging-and-File-Naming_57815315.html).
