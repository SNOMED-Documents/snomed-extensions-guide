...
As previously mentioned, all reference sets use six [common attributes](4.3.2.1-Common-Attributes_57816374.html). In addition to these, a [ | Language type reference set|](http://snomed.info/id/900000000000506000 "900000000000506000 | Language type reference set |") also includes an **acceptabilityId**. The table below explains how each of these attributes is populated in a [ | Language type reference set|](http://snomed.info/id/900000000000506000 "900000000000506000 | Language type reference set |") . 
...
<figure><img src="../../../../images/57815130.png" alt="" title=""><figcaption><p>Figure 4.3.2.4.1-1: Rows from the |Canada French language reference set</p></figcaption></figure>
