...
Note that, content added to an extension can later be promoted to another extension or to the International Edition. For more information, please refer to [5.4.1.1 Promotion and Demotion](5 Key Steps/5.4.1.1-.1.md).
...
<img src="../images/57815400.png" alt="" title="" style="max-width: 100%; height: auto;">
