...
The change management process can be divided into three distinct phases:
  ...
  1. [Identify changes](5 Key Steps/5.7.1.1-.1.md)
  2. [Assess change impact](5 Key Steps/5.7.1.2-.2.md)
  3. [Update extension](5 Key Steps/5.7.1.3-.3.md)

After change management has been performed, it is important that thorough [review and validation](5 Key Steps/5.5-.5.md) of the resulting extension is performed.
