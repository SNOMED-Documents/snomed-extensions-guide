...
The following guidance is provided for organizations which have been issued namespace identifiers to create content in their own extension:
  ...
  * _item-identifiers_ should not be generated so as to have meaning. They should be regarded as meaningless numbers. (Recall that an item identifier precedes the [namespace](4 Logical Design/4.1-.1.md) identifier in an SCTID.)
