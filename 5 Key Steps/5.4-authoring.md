...
The following sections present key principles for authoring components and reference sets within an extension.
  ...
  * [5.4.1 General Authoring Principles](5 Key Steps/5.4.1-.1.md)
  * [5.4.2 Authoring Concepts](5 Key Steps/5.4.2-.2.md)
  * [5.4.3 Authoring Descriptions](5 Key Steps/5.4.3-.3.md)
  * [5.4.4 Authoring Relationships](5 Key Steps/5.4.4-.4.md)
  * [5.4.5 Authoring Reference Sets](5 Key Steps/5.4.5-.5.md)
  * [5.4.6 Authoring Reference Set Members](5 Key Steps/5.4.6-.6.md)
